...
class MsVideoSeeder extends Seeder
{
    public function run()
    {
        DB::table('ms_videos')->insert([
            ...
            [
                'UserID' => 1,
                'VideoImage' => 'product_images/Goblin.jpg',
                'VideoLinkEmbedded' => 'storage/short_video/www.mp4',
                'Title' => 'Beer',
                'Description' => 'Beer making is a hard work',
                'PostTime' => Carbon::now(),
                'Views' => 0,
                'Like' => 0,
                'Dislike' => 0,
            ...
            [
                'UserID' => 1,
                'VideoImage' => 'product_images/Default.jpg',
                'VideoLinkEmbedded' => 'storage/short_video/ppp.mp4',
                'Title' => 'Vase',
                'Description' => 'Vase making is a hard work',
                'PostTime' => Carbon::now(),
                'Views' => 0,
                'Like' => 0,
                'Dislike' => 0,
            ...
            [
                ...
                'VideoLinkEmbedded' => 'storage/short_video/ppp.mp4',
                'Title' => 'Vase',
                'Description' => 'Vase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard workVase making is a hard work',
                'PostTime' => Carbon::now(),
                'Views' => 0,
                'Like' => 0,
                'Dislike' => 0,
